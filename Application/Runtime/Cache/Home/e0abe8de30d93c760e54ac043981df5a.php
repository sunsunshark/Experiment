...
<head>
    ...
    <link rel="stylesheet" href="/Experiment7/Public/Home/css/bootstrap.css" type="text/css" />
    <link rel="stylesheet" href="/Experiment7/Public/Home/css/simple-line-icons.css" type="text/css" />
    <link rel="stylesheet" href="/Experiment7/Public/Home/css/app.css" type="text/css" />
</head>
<body background="/Experiment7/Public/Home/images/bodybg.jpg">
<section id="content" class="m-t-lg wrapper-md animated fadeInUp ">
    <div class="container aside-xl" style="margin-top: 48px;">
        ...
        <section class="m-b-lg center">
            <header class="wrapper text-center">
                <strong class="text-sucess">欢迎登录</strong>
            </header>
            <form action="/Experiment7/index.php/Home/Login/checkLogin" method="post" >

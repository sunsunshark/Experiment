...
<link rel="stylesheet" type="text/css" href="/Experiment7/Public/Teacher/css/common.css"/>
<link rel="stylesheet" type="text/css" href="/Experiment7/Public/Teacher/css/main.css"/>
<body>
...
<?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="myDiv" style="width: 80%;height: 30%; " >
		...
		<div style="width: 25%;float: left;height: 100%;" >
			<img src="/Experiment7/Source/Course/<?php echo ($data['img']); ?> " alt="" style="width:100%;height: 100%; ">
		</div>
